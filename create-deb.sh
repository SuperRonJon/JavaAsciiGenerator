...
fpm -s dir -t deb -p ascii-generator-2.5.0-any.deb \
...
cd ..
mkdir -p out/
cp target/ascii-generator-2.5.0-any.deb out/ascii-generator-any.deb
echo "Created deb at target/ascii-generator-2.5.0-any.deb!"
